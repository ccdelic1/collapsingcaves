...
public class PlacedBlockTracker extends SavedData {
    ...
    private static final Identifier DATA_ID = Identifier.fromNamespaceAndPath("collapsingcaves", DATA_NAME);
    ...
    public static final SavedDataType<PlacedBlockTracker> TYPE = new SavedDataType<>(
            DATA_ID, PlacedBlockTracker::new, CODEC, DataFixTypes.LEVEL
    );
